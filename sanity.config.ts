...
import perfumeType from 'schemas/perfume'
...
export default defineConfig({
  ...
  schema: {
    ...
    types: [authorType, postType, settingsType, perfumeType, cosmeticsType, elderlyType, vitaminType, childrenType, pregnancyType],
  },
  plugins: [
    deskTool({
