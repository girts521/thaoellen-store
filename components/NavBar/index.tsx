        ...
        <div>
            <div className={styles.container}>
                ...
                <div className={styles.imagecontainer}>
                    ...
                    <Image className={styles.mobile} onClick={handleBurgerMenuClick} src={isBurgerMenuOpen ? '/Close.png' : '/Burger.png'} alt="Burger menu" width={25} height={25} />
            ...
            <div className={`${styles.burgerMenuContent}`} style={{ height: isBurgerMenuOpen ? '100%' : 0 }}>
